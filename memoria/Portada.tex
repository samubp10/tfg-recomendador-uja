...
% viene de la plantilla oficial del Dpto. de Informática (Charte), no de una
% elección propia; es defendible ante el tutor por ese origen.
...
\newcommand{\Portada}{ %
    ...
    \begin{textblock*}{18.45cm}(1.4cm,12cm)
        ...
        % 30-36pt; resto de campos (grado, autor, fecha) 16-18pt. Antes iban a 26/14/14,
        % por debajo del mínimo exigido en tres de los cuatro campos dinámicos.
        {\fontsize{32}{40}\selectfont \textbf{\color{naranja}\TituloTFG}}
      \vspace{.5cm}

      {\fontsize{18}{21}\selectfont Autor: \Estudiante}

      {\fontsize{18}{21}\selectfont Grado: Ingeniería en Informática}
      ...
      \vspace{0.3cm}
      {\fontsize{18}{21}\selectfont Fecha: \Fecha}
    \end{textblock*}
    ~
    \clearpage
    \ClearWallPaper
