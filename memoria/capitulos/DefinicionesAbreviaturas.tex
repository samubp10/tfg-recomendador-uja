...
\begin{description}          
  ...
  \item[\gldestino{HTTP}HTTP] \textcolor{borrador2}{Protocolo de transferencia de
          hipertexto (\textit{Hypertext Transfer Protocol}), con el que se
        comunican entre sí las piezas de la aplicación web.}
  ...
  \item[\gldestino{WCAG}WCAG] \textcolor{borrador2}{Pautas de accesibilidad para
          el contenido web (\textit{Web Content Accessibility Guidelines}), la
        norma con la que se comprueba que una página pueda usarla alguien que
        no ve la pantalla o no maneja el ratón.}
