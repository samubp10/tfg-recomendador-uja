...
\begin{description}          
  ...
  \item[Exhaustividad (\textit{Recall@K})] \textcolor{borrador2}{Métrica de
  ...
  \item[Fidelidad del índice] \textcolor{borrador2}{Grado en que una base de
  ...
  \item[Fidelidad de la respuesta (\textit{faithfulness})]
  ...
  \item[Generación aumentada por recuperación] Arquitectura que, antes
  ...
  \item[Rango recíproco medio (\textit{Mean Reciprocal Rank}, MRR)]
...
\begin{description}          
  ...
  \item[MRR] \textcolor{borrador2}{Rango recíproco medio (\textit{Mean
          Reciprocal Rank}).}
  ...
  \item[RAG] Generación aumentada por recuperación (\textit{Retrieval-Augmented Generation}).
