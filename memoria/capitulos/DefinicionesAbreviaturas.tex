...
\begin{description}          
  ...
  \item[\gldestino{CSS}CSS] Hojas de estilo en cascada
        (\textit{Cascading Style Sheets}), lenguaje utilizado para definir la
        presentación visual y el diseño de la interfaz web.
  ...
  \item[\gldestino{HTTPS}HTTPS] Protocolo seguro de transferencia de
        hipertexto (\textit{Hypertext Transfer Protocol Secure}). Versión protegida
        del protocolo HTTP mediante cifrado TLS para asegurar las peticiones web.
