...
\textcolor{borrador2}{Dentro de esta delimitación, se excluye además del corpus la modalidad en extinción de una titulación cuando coexiste con un plan de estudios vigente que la sustituye: un estudiante preuniversitario no puede matricularse en un plan que ya no admite nuevo alumnado, por lo que incluirlo entre las recomendaciones del sistema induciría a error (IT-77).}
