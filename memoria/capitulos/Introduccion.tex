...
El sistema está diseñado para orientar a estudiantes preuniversitarios (Educación Secundaria, Bachillerato y Formación Profesional) que se encuentran en fase de búsqueda y decisión sobre su futura carrera universitaria. Por este motivo, la extracción de datos de las \glr{guías docentes}{guía docente} se han acotado a:
\begin{itemize}
...
\begin{borrador}
  \item \textbf{Fase:} 3--5 (IT-47, IT-51, IT-54). Esta lista no menciona los
        anexos porque todavía no existe ninguno, pero hay tres tarjetas que los
        producen: documentación técnica de la API, resultados completos de la
        validación con usuarios e instalación y configuración del sistema. Al
        crear el primero hay que añadir aquí su viñeta y el
        \texttt{\textbackslash input} correspondiente en \texttt{main.tex}.
\end{borrador}