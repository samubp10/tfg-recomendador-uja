...
Como se observa en la Figura~\ref{fig:arquitectura_pipeline}, primero se obtienen los datos necesarios para las recomendaciones (grados, asignaturas, guías y salidas laborales); a continuación, estos se pasan por el fragmentador (\textit{chunker}), que parte el texto según se especifica en el apartado ~\ref{cap:} (falta el apartado de la decisión del chunker ADR-0001).
...
\textcolor{blue}{[sbp] Corregido: he ampliado la figura del 50\% al 90\% del ancho de página. Si sigue resultando pequeña, la regeneraré con una fuente mayor.}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{imagenes/Diagrama_arquitectura.pdf}
...
\textcolor{blue}{[sbp] Corregido: ampliada del 60\% al 95\% del ancho de página.}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{imagenes/Diagrama_secuencia_scraping.pdf}
