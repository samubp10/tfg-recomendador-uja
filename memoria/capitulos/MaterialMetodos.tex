...
\begin{borrador}
  \item \textbf{Fase:} 2 (IT-58) --- matiz honesto sobre esta afirmación, para
        ...
        \emph{no} reproduce el mismo corpus: la fuente había cambiado (guías del
        curso 2026-27 servidas en PDF, resuelto en IT-67; y dos titulaciones de
        Geomática con la tabla de asignaturas reestructurada, aún sin resolver).
        Es decir, el pipeline reproduce <<el estado actual de la fuente>>, que no
        es lo mismo que <<el corpus sobre el que se hicieron los experimentos>>.
        La reproducibilidad exacta exige, además del pipeline, fijar la fecha de
        rastreo y aceptar que la fuente es un blanco móvil. Conviene decir de qué
        curso y fecha es el corpus (2025-26, rastreo del 09/07/2026) al
        caracterizarlo en IT-58, en vez de presentarlo como atemporal.
\end{borrador}