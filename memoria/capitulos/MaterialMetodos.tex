...
% Replanificado el 16/07/2026: la Fase 0 se alargó más de lo previsto y el
% objetivo pasa de la Extraordinaria II del curso 2025/26 (3/9/2026) a la
% primera convocatoria del curso 2026/27, que por analogía con el calendario
% 2025/26 caerá a mediados de noviembre de 2026 (fecha provisional hasta que
% la EPSJ publique el calendario 2026/27). Día 1 del diagrama = 24/06/2026.
\begin{figure}[htbp]
    \centering
    \resizebox{\textwidth}{!}{%
    \begin{ganttchart}[
        ...
        \gantttitle{Oct.}{31}
        \gantttitle{Nov.}{14} \\
        \ganttbar{F0 · Cimientos}{1}{38} \\
        \ganttbar{F1 · Embeddings y vector DB}{39}{69} \\
        \ganttbar{F2 · Pipeline RAG}{70}{99} \\
        \ganttbar{F3 · Aplicación web}{100}{121} \\
        \ganttbar{F4 · Validación y ablation}{122}{135} \\
        \ganttbar{F5 · Cierre y defensa}{136}{144} \\
        \ganttmilestone{Entrega}{142}
    \end{ganttchart}%
    }
    \caption{Planificación temporal del proyecto por fases, replanificada a la
    primera convocatoria del curso 2026/27 (noviembre de 2026, fecha
    provisional). Fuente: Elaboración propia.}
    \label{fig:gantt}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{imagenes/diagrama_arquitectura_pipeline.pdf}
    \caption{Arquitectura general del sistema, organizada por fases de desarrollo. Fuente: Elaboración propia.}
...
\begin{figure}[H]
    ...
    desarrollo (versión alternativa). Fuente: Elaboración propia.}
    \label{fig:arquitectura_pipeline_tikz}
\end{figure}
