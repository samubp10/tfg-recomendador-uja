...
\begin{borrador}
  \item Falta texto introductorio en este apartado: una o dos frases que digan qué se comparó
  y sobre qué, y remitan al Capítulo~\ref{cap:materialesymetodos} para el diseño.
...
\begin{borrador}
  \item \textbf{Falta enunciar la conclusión.} La sección compara y no dice en ninguna parte
  qué se decide: estrategia estructural, con máximo y objetivo en 900 caracteres y mínimo en
  200. Un apartado que compara alternativas y no enuncia cuál gana deja el trabajo a medias.
  \item \textbf{Y falta un aviso que evita una contradicción aparente:} el troceo por
