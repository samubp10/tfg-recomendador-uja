...
\textcolor{borrador2}{Cinco de las doce titulaciones del centro ---las dobles---
estuvieron en la colección sin una sola asignatura hasta el 5 de agosto de 2026. No era
que la fuente no publicase su plan de estudios, sino que lo publica bajo una dirección
distinta de la de los grados simples, rotula una de sus columnas de otra forma y abrevia
de otra manera el carácter de cada asignatura. Ninguna de esas tres diferencias provocaba
un error: la titulación entera desaparecía y la verificación seguía dando el visto bueno.
Es la misma clase de fallo que este trabajo ya ha documentado en otras cuatro ocasiones, y
la que justifica que la colección se verifique contra la fuente completa y no contra una
muestra.}
...
\textcolor{borrador2}{Por último, la colección creció de setecientos noventa y siete a
ochocientos ochenta y cuatro fragmentos al incorporar estas titulaciones. La comparación
de modelos de incrustaciones se ejecutó sobre la colección anterior, así que sus cifras
absolutas no corresponden a la colección vigente. El orden entre los modelos no debería
verse afectado ---ya se comprobó estable sobre dos colecciones distintas---, pero
presentarlas sin esta advertencia sería atribuirles una vigencia que no tienen.}
...
\begin{borrador}
  ...
  \item \textbf{Cifras del 05/08/2026:} 528 asignaturas, 288 guías, 8 bloques de salidas,
        884 fragmentos (761 de guía, 86 informativos, 24 de plan de estudios y 13 de
        salidas). 363 fragmentos citan una titulación doble, y 329 de ellos son fragmentos
        de guía reaprovechados: no se duplicó ni un carácter de temario.
