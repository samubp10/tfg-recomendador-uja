...
\begin{figure}[H]
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tikzpicture}[
      ...
      -- node[etiqueta]{283 unidades de guía: 5 copias que no se repiten} (0,-5.6);
      ...
      {[283 de guía, 8 de salidas y los listados compuestos]};
      ...
      \draw[mensajeFin] (0,-11.3) -- node[etiqueta]{1.836 fragmentos} (14.8,-11.3);
      \draw[mensaje]    (0,-12.0)
