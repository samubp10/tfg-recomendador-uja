...
\begin{figure}[H]
  ...
  \caption{\textcolor{borrador2}{De dónde sale el sujeto en cada turno. En el
    primero la titulación solo aparece en la respuesta del asistente, nunca en
    lo que escribe el estudiante: mirando únicamente las preguntas, el sistema
    no sabría de qué se está hablando.}}
