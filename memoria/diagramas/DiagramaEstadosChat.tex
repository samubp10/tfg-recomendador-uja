...
%     en la interfaz.
%
% Corregido el 29/08/2026: la nota decia que la primera fase se llamaba
% «Buscando en las guias docentes» y que el cambio de texto ocurria a los 12 s.
% Las dos cosas dejaron de ser ciertas en IT-45. El rotulo es ahora «Buscando en
% la informacion de la Escuela», y la fase la marca la LLEGADA DE LAS FUENTES,
% que es el suceso real que cierra la recuperacion; con el cronometro anterior
% podia anunciar «redactando» con la busqueda todavia en marcha.
