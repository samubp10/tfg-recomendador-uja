% !TEX root = ../main.tex
% Dos configuraciones de la rejilla del recuperador (IT-49), elegidas para que
...
%
% Por que estas dos y no las veinte mejores: la primera es la que la rejilla
% prefiere y la segunda la que se adopta. Sin las dos juntas no se ve la
% decision, que es lo unico que esta seccion tiene que contar.
%
% Habia una tercera fila, "De partida" (factor 1,20 y suelo 0,142), que se ha
% retirado: su suelo no aparece en ninguna parte de it49-recuperador.md, de modo
% que era la unica cifra de la tabla sin artefacto de procedencia. Si se quiere
% recuperar hay que volver a ejecutar el barrido y que el informe la publique.
\begin{table}[htbp]
  \centering
  \small
