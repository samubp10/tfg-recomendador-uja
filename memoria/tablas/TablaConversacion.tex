...
% (IT-106). Las cifras las produce scripts/experimentos/experimento_conversacion.py sobre las
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}l cccc cccc@{}}
    ...
    \midrule
    Sin conversación                & \sout{0,080}\,\textcolor{borrador2}{0,040}     & 0,333                            & 1,000 & \sout{0,359}\,\textcolor{borrador2}{0,333} & \sout{0,005}\,\textcolor{borrador2}{0,002} & 0,022 & 0,275 & \sout{0,082}\,\textcolor{borrador2}{0,080} \\
  ...
  \begin{minipage}{0.95\textwidth}
    ...
    vale 1 si sale siempre el primero. \textcolor{borrador2}{Cifras producidas
      por \texttt{scripts/experimentos/experimento\_conversacion.py} sobre el
      corpus de 1.922 fragmentos, el mismo con el que se midieron el resto de
      los experimentos de esta memoria. La salida literal del guion está en
      \texttt{docs/experimentos/it106-conversacion.md}\cite{repo_tfg}.}
  \end{minipage}
\end{table}
