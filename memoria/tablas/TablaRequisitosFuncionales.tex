...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l >{\hsize=1.42\hsize}Y c >{\hsize=0.58\hsize}Y@{}}
    ...
    \midrule
    RF-01 & Construir la colección documental a partir de la web oficial de la EPSJ, conservando la procedencia de cada dato                & OE1 · RU-02 & ADR-0002 \\
    ...
    RF-05 & Redactar la respuesta empleando únicamente los fragmentos recuperados                                                            & OE4 · RU-02 & ADR-0005 \\
  ...
  \begin{minipage}{0.95\textwidth}
    ...
    decisión tomada por experimentación, y su justificación y sus alternativas
    están en ese registro; los que remiten a una sección salen de una decisión
