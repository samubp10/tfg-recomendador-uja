\begin{table}[htbp]
  \centering
  \caption[Efecto del tamaño máximo con la estrategia elegida]{\textcolor{borrador2}{Efecto
      del tamaño máximo del fragmento, manteniendo fija la estrategia estructural con el
      objetivo igualado al máximo. Cincuenta preguntas del conjunto de evaluación.}}
  ...
  \begin{minipage}{0.95\textwidth}
    ...
    \textcolor{borrador2}{Es la única fila que gana en las tres métricas a la vez, y lo hace
      con la mitad de fragmentos que la de 600 caracteres.}
  \end{minipage}
\end{table}
